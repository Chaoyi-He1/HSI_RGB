...
def save_conv_weights(model, save_path):
    conv_layer = model.atten.weight.data
    if not os.path.exists(save_path):
            os.makedirs(save_path)
...
def load_weights(model: torch.nn.Module, load_path): 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', default='/data/chaoyi_he/HSI/HSI_RGB/path/cls', help='dataset')
    parser.add_argument('--name', default='', help='renames results.txt to results_name.txt if supplied')
    
    parser.add_argument('--use_rgb', default=True, type=bool, help='use MF')
    parser.add_argument('--use_HVI', default=False, type=bool, help='use HVI')
